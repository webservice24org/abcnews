...
<body style="margin:0; padding:0; font-family: Arial, sans-serif; background-color:#f4f4f4;">
    ...
    <table align="center" cellpadding="0" cellspacing="0" width="800" style="border-collapse:collapse; background:#ffffff; margin-top:30px; border-radius:8px; overflow:hidden; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
        <!-- Header -->
        <tr>
            <td align="center" bgcolor="#d9230f" style="padding: 20px 0;">
        ...
        <!-- Footer -->
        <tr>
            <td bgcolor="#f8f8f8" style="padding: 20px; font-size:13px; color:#666666; text-align:center; border-top:1px solid #e0e0e0;">
