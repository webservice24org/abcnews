    ...
    >
       ...
       <div class="flex flex-col mt-4">
           <div
               ...
               class="bg-gray-300 text-black p-2 mt-4 rounded cursor-pointer hover:bg-gray-300"
               :class="'{{route('admin.comments.dashboard')}}' === window.location.href ? 'border-l-4 border-gray-500' : ''"
           >
               <span class="text-black">Dashboard</span>
           </div>
           <div class="font-bold text-lg mt-4 mb-2 text-black">Models</div>
           @foreach($models as $key => $model)
                <div
                    wire:click="navigate('{{$key}}')"
                    class="bg-gray-300 text-black p-2 mb-4 flex gap-x-2 justify-between items-center rounded cursor-pointer hover:bg-gray-300"
